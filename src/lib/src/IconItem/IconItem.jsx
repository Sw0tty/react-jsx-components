    ...
    renderComponent() {
        return (
            <div className="iconitem-container">
                <div className="iconitem-iconbox" style={{ WebkitFilter: this.props?.addGlow ? `drop-shadow(0px 0px ${this.props?.glowStrong ? `${this.props?.glowStrong}px` : "5px"} ${this.props?.glowColor ?? this.props.iconColor})` : "none" }}>

            ...
            <Playground title="Tip"
                ...
                componentProps={<>
                    <Tip caption="Allowed icons: Warning, Error" iconColor="#25cf8f" addGlow={true}>                            
                        <TextBox width={200} disabled={false} required={false} maxLength={100} caption="IconPath :" placeholder="Test icons in './icons/'" value={this.state?.iconPath} onReturnData={{ func: this.setData, params: { propName: "iconPath" } }} />
                    </Tip>
                    <ColorPicker caption="IconColor" disabled={false} onReturnData={{ func: this.setData, params: { propName: "iconColor" } }} />
                    <TextBox width={200} disabled={false} required={false} maxLength={255} caption="Tip caption :" value={this.state?.caption} onReturnData={{ func: this.setData, params: { propName: "caption" } }} />
